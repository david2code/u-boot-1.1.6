...
ifeq ($(ARCH),arm)
CROSS_COMPILE = /home/david/tq2440/opt/crosstools_3.4.5_softfloat/gcc-3.4.5-glibc-2.3.6/arm-linux/bin/arm-linux-
endif
ifeq ($(ARCH),i386)
ifeq ($(HOSTARCH),i386)
CROSS_COMPILE =
...
$(obj)u-boot.bin:	$(obj)u-boot
		...
		cp u-boot.bin /home/david/image/u-boot_david.bin
...
david2440_config	:	unconfig
	@$(MKCONFIG) $(@:_config=) arm arm920t david2440 NULL s3c24x0
